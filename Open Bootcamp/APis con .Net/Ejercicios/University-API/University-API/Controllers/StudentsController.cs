...
namespace University_API.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
       // private readonly UniversityContext _context;
        ...
        public StudentsController(Services.Services services)
        {
            //_context = context;
            _services = services;   
        }
        ...
        [HttpGet("/api/Student/ListaConCursos")]
        public ActionResult<IEnumerable<Student>> GetUsersWithCurses()
        {
            var listaUsuarios = _services.GetUsersWithCurses();
            List<string> users = new List<string>();
            foreach (var item in listaUsuarios)
            {
                users.Add(item.Name + " " + item.LastName);
            }
