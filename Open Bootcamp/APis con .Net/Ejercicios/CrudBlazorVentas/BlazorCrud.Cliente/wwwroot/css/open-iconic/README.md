...
To learn more about SVG Sprites, read [Chris Coyier's guide](https://css-tricks.com/svg-sprites-use-better-icon-fonts/).
...
All code (including SVG markup) is under the [MIT License](https://opensource.org/licenses/MIT).

### Fonts

All fonts are under the [SIL Licensed](https://scripts.sil.org/cms/scripts/page.php?item_id=OFL_web).
